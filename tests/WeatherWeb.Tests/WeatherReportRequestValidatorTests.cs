...
public class WeatherReportRequestValidatorTests
{
    [Theory]
    ...
    {
        // Arrange
        var validator = new WeatherReportRequestValidator();
        var dto = new WeatherReportRequest(temperatureC, humidity, location);
